...
( PL_CODE bigint primary key ,
  ...
  PPL_PPL_CODE integer not null default 10,
  constraint uk_PROG_TEST.PEOPLE unique (PPL_NAME, PPL_PPL_CODE),
  constraint fk_PROG_TEST.PEOPLE foreign key  (PPL_PPL_CODE) references ROG_TEST.DOCS(DOC_PPL_CODE)
);
